import { ArrowDown, Star, Bike, Clock } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <img
        src={item.photo}
        alt={item.name}
        className="w-full object-cover h-58 lg:h-50 rounded-2xl"
      />
      ...
      <div className="p-5 space-y-4">
        ...
        <div className="flex items-center justify-between text-sm">
          ...
          <div className="flex ites-center gap-2 font-semibold text-jinc-600">
