...
const RestaurantDetail = () => {
  ...
  if (!restaurant) return <div className="h-37.5" />;

  return (
    <div className="flex flex-1 gap-4 max-xs:flex-col sm:flex-row sm:items-center">
      <img
        src={restaurant.photo}
        className="size-[150px] rounded-2xl object-cover show-inner"
      />
